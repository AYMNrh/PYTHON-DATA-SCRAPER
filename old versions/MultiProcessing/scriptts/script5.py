...
with concurrent.futures.ThreadPoolExecutor(max_workers=16) as executor:
    ...
    # results = executor.map(fetch_data, range(16921,21151)) #2-4230-8460-12690-16920-21150-25380-29610-33840-38070-42300-46530-50760-55342 add one to the page number
    # print results type   
    results = executor.map(fetch_data, range(1301,1626))
    print(type(results))
    ...
    for i, result in enumerate(results):
        if result is not None:
            ...
            file_name = f"{directory}/transactions_5.csv"
