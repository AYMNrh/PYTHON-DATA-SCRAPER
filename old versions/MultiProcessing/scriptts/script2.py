...
with concurrent.futures.ThreadPoolExecutor(max_workers=16) as executor:
    ...
    # results = executor.map(fetch_data, range(4231,8461))
    results = executor.map(fetch_data, range(326,651))
    #2-4230-8460-12690-16920-21150-25380-29610-33840-38070-42300-46530-50760-55342 add one to the page number
    # print results type   
    print(type(results))
